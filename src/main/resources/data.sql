...
-- admin: login 'lapenok.aleksej@gmail.com', password='123'
 INSERT IGNORE INTO user
  ...
  (1, 'Aleksej Lapenok','Алексей Лапенок', 'lapenok.aleksej@gmail.com', 'Aleksej', 'Алексей', 'Lapenok', 'Лапенок', '$2a$10$jw5JfVPuTYmVl6WpxCT0R.NcMxHr9Z1HZf445oSebT0VmRg72Tcxq', 1);
